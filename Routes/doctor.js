...
Router.put("/Update:ID", (req, res) => {
  ...
  console.log(Details);
  Result("doctor", "Update", Details, UpdatedDetails)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
